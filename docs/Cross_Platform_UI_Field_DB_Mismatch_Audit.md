...
> **Canonical copy for tracking lives in [`bugs/`](../bugs/)**  
> - Tracker: [`bugs/BUGS.md`](../bugs/BUGS.md)  
> - Full audit: [`bugs/web-flutter-db-mismatch.md`](../bugs/web-flutter-db-mismatch.md)
